      ...
      {props.post.acf.nombre_del_establecimiento ? (
        <title
          dangerouslySetInnerHTML={{
            __html: props.post.acf.nombre_del_establecimiento + ' - Familias Numerosas'
          }}
        />
      ) : (
        ''
    ...
    <nav aria-label="Estás aquí:" role="navigation">
      <ul className="breadcrumbs">
        ...
        <li>
          <Link
            prefetch
            as={`/c-ca/${props.post.categoria_del_beneficio}/${
              props.post._embedded['wp:term'][0][0].slug
            }/${props.post.acf.comunidad_autonoma}/8143`}
            href={`/category-comunidad?sid=${props.post.categoria_del_beneficio}&comunidad=${
      ...
      <div className="file">
        ...
        <h4 className="location dont-break-out">
          <span>
            ...
            <Link
              prefetch
              as={`/l/${props.post.acf.localidad_del_beneficio.term_id}/${
                props.post.acf.localidad_del_beneficio.slug
              }`}
              href={`/localidad?localidad=${props.post.acf.localidad_del_beneficio.term_id}`}
            >
              <a
                title={'Ver todos los beneficios de ' + props.post.acf.localidad_del_beneficio.name}
              >
                <span
                  dangerouslySetInnerHTML={{ __html: props.post.acf.localidad_del_beneficio.name }}
                />
              </a>
            </Link>
          </span>
            ...
            {props.post.acf.texto_descriptivo_adicional_con_enlace ? (
              <p>
                ...
                <Link href={props.post.acf.enlace_con_informacion_adicional_de_la_oferta}>
                  <a title={props.post.acf.texto_descriptivo_adicional_con_enlace} target="_blank">
