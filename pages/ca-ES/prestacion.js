        ...
        'Municipal' ? (
          <li>
            <Link
              ...
              href={`/ca-ES/prestaciones-municipio?localidad=${
                props.prestacion.acf.localidad.term_id
              }`}
            >
              <a>
                <span
        ...
        'Autonómico' ? (
          <li>
            <Link
              ...
              href={`/ca-ES/prestaciones-comunidad?comunidad=${
                props.prestacion.acf.comunidad_autonoma.term_id
              }`}
            >
              <a>
              ...
              >
                <a
                  title={
                    ...
                    props.prestacion.acf.localidad.name
                  }
                >
                  <span
                    dangerouslySetInnerHTML={{
