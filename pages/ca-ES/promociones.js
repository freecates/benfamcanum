      ...
      <IntlProvider defaultLocale="ca">
        ...
        todayISO ? (
                ...
                .map((promocione, index) => (
                  <tbody key={index}>
                    <tr>
                      ...
                      <td width="200">
                        {promocione.acf.categoria_de_la_promocion.name}
                      </td>
                      <td>
                        <span
                        ...
                        <span>
                          ...
                          <strong>
                            ...
                            <FormattedDate
                              value={
                                promocione.acf
                                  .fecha_de_finalizaciion_de_la_promocion
                              }
                              day="numeric"
                              month="long"
                              year="numeric"
                      ...
                      <td width="150">
                        <Link
                          ...
                          href={`/ca-ES/promocion?id=${promocione.id}`}
                        >
                          <a
                            title={
                              'Accedir a la fitxa de ' +
                              promocione.acf.nombre_de_la_empresa
                            }
          ...
          <h2 className="align-center">
            Ho sentim. Cap oferta en curs en aquests moments.
          </h2>
        )}
      </IntlProvider>
    </section>
...
Promocions.getInitialProps = async function(context) {
  const res = await fetch(
    `https://gestorbeneficis.fanoc.org/wp-json/wp/v2/promociones`
  )
