          ...
          <ul className="gallery">
            {props.ofertasporsectores.map((ofertasporsectore, index) => (
              <li className="item align-center" key={index}>
                <Link
                  as={`/ca-ES/c-ca/${ofertasporsectore.term_id}/${ofertasporsectore.slug}/Catalu/8196`}
                  href={`/ca-ES/category-comunidad?sid=${ofertasporsectore.term_id}&comunidad=Catalu&caid=8196`}
                >
