  ...
  return (
    <Layout>
      ...
      <p>
        ...
        exclusivament, per al seu ús personal i privat. Per a la utilització amb fins comercials
        dels continguts del web, la seva distribució, així com la seva modificació, alteració o
      ...
      <p>
        ...
        la seva seu web ia no emprar-los per incórrer en activitats il·lícites o contràries a la
        bona fe ia l'ordenament legal.
      </p>
      <p>
        Amb la voluntat de millorar la pàgina web, FANOC es reserva el dret d'efectuar les
        modificacions que consideri oportunes, podent canviar, suprimir o afegir tant els continguts
        i serveis que presta com la forma en què aquests apareguin presentats o localitzats.
      </p>
      <p>
        ...
        alguna de les seves pàgines, l'usuari ha de saber que està entrant a la pàgina web de FANOC
        i ha de percebre en el seu navegador la seva adreça URL. Si FANOC detecta l'incompliment de
        les anteriors condicions, així com qualsevol utilització indeguda dels continguts presentats
        a la seva pàgina web, es reserva el dret d'exercir totes les accions civils i penals
        necessàries.
      </p>
      ...
      <p>
        ...
        aquesta legislació respecte a la protecció de dades personals dels seus usuaris i els manté
        en la més estricta confidencialitat d'acord amb el que disposa la Llei Orgànica 15/99 del 13
        de desembre de 1999 sobre Protecció de Dades de Caràcter Personal (LOPD) , així com en el
        que disposa la Llei de Serveis de la Societat de la Informació i del Comerç Electrònic
        (SSICE) llei 34/2002 d'11 de juliol.
      </p>
      <p>
        L'usuari registrat en els serveis de la seu web de FANOC pot en tot moment exercitar els
        drets d'accés, rectificació i cancel·lació en els termes previstos en la LOPD i altres
        normes que la desenvolupen. Pot fer-ho per correu electrònicelectrónico{' '}
