  ...
  <Layout ruta={props.ruta}>
    ...
    <section className="call-to-action">
      ...
      <p>
        ...
        conseguir más y mejores beneficios para las familias numerosas, porque cuantos más seamos,
      ...
      <p className="text-left">
        Tenemos{' '}
        <a href="http://www.familiasnumerosas.org/conocenos/nuestras-asociaciones/" target="_blank">
          Asociaciones en toda España
        </a>
        ; deberás asociarte en la de tu localidad o en la más cercana a tu domicilio. Busca el email
        y envíales tu documentación. En breve se pondrán en contacto contigo y te remitirán tu carné
        de socio para que empieces a disfrutar cuanto antes de sus beneficios.
      </p>
      ...
      <p className="text-left">
        Si simplemente quieres pedir información, busca los datos de la Asociación que te interese y
        ponte en contacto con ella, a través de correo electrónico o teléfono.
      </p>
