      ...
      {props.promocion.acf.nombre_de_la_empresa ? (
        <title
          dangerouslySetInnerHTML={{
            __html: props.promocion.acf.nombre_de_la_empresa + ' - Familias Numerosas'
          }}
        />
      ) : (
        ''
    ...
    <nav aria-label="Estás aquí:" role="navigation">
      <ul className="breadcrumbs">
        ...
        <li>
          ...
          <span dangerouslySetInnerHTML={{ __html: props.promocion.acf.nombre_de_la_empresa }} />
        </li>
      </ul>
    </nav>
        ...
        <div className="file-data">
          <div className="file-content">
            <h4 className="align-center">
              <span className="label alert file-label">¡Promoción!</span>
            </h4>
